...
public enum ErrorCodes : Int {
  ...
  case noOpenTable = 10016
    ...
    public  func getError(message: String? = nil)-> NSError{
        ...
        let error = NSError(domain: Const.serverErrorDomain, code: self.rawValue, userInfo: [NSLocalizedDescriptionKey : msg])
        return error
    }
...
public class Networking {
    ...
    public func configure(_ publishableKey: String? = nil, environment: Environment? = nil, success: ((_ JSON: [String:Any]) -> Void)? , fail:((_ error: NSError) -> Void)?){
        ...
        network!.request(urlStr, method: .get, parameters: nil , success: { JSON in
            ...
            guard let coreJSON: [String:Any] = JSON["core"] as? [String : Any] else{
...
fileprivate extension Environment{
    ...
    func getCDNAddresses() -> String{
        switch self {
        case .test:
            return "https://s3-eu-west-1.amazonaws.com/mywallet-sdk-testing/CoreConfig/v1/main.json"
        case .sandbox:
            return "https://s3-eu-west-1.amazonaws.com/mywallet-sdk-sandbox/CoreConfig/v1/main.json"
        case .production:
            return "https://s3-eu-west-1.amazonaws.com/mywallet-sdk-production/CoreConfig/v1/main.json"
        }
    }
}
